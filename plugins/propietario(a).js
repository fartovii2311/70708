...
if (!fs.existsSync(`./София/${conn.user.jid.split`@`[0]}/creds.json`)) {
...
const path = conn.user.jid != global.conn.user.jid ? `./София/${conn.user.jid.split`@`[0]}/creds.json` : `./GataBotSession/creds.json`
